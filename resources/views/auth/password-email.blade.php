...
<body class="bg-imgs">
    <div class="container d-flex justify-content-center align-items-center vh-100">
        <div class="card d-flex flex-column align-items-center w-200 px-4">
            <h3 class="text-primary text-success mb-4">Atur Ulang Sandi Anda</h3>
            <img src="{{asset('sbadmin/img/i-email.svg')}}" alt="email" class="img-fluid mb-3" style="max-width: 250px;">
