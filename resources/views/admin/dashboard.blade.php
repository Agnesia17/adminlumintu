        ...
        const createChart = (data) => {
            ...
            transactionChart = new Chart(ctx, {
                ...
                data: {
                    labels: ['Jan', 'Feb', 'Mar', 'Apr', 'Mei', 'Jun', 'Jul', 'Agu', 'Sep', 'Okt', 'Nov', 'Des'],
                    datasets: [{
                        label: typeSelect.value === 'penjualan' ? 'Penjualan' : 'Pembelian',
                        data: Object.values(data),
                        borderColor: typeSelect.value === 'penjualan' ? 'rgb(45, 206, 137)' : 'rgb(66, 153, 225)',
                        backgroundColor: typeSelect.value === 'penjualan' ?
                            'rgba(45, 206, 137, 0.1)' : 'rgba(66, 153, 225, 0.1)',
                        borderWidth: 2,
                        tension: 0.4,
                        fill: true
                    }]
                ...
                options: {
                    ...
                    scales: {
                        y: {
                            ...
                            ticks: {
                                callback: function(value) {
                                    // Format Y-axis values to Indonesian Rupiah
                                    if (value >= 1000000000) {
